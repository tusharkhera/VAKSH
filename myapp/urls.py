...
urlpatterns = [
    ...
    path('ayurvedic-products/', views.ayurvedicProduct, name='ayurvedic-products'),
    path('beverages-products/', views.beveragesProduct, name='beverages-products'),
    path('clay-products/', views.clayProduct, name='clay-products'),
    path('dryFruits-products/', views.dryFruitsProduct, name='dryFruits-products'),
    path('flour-products/', views.flourProduct, name='flour-products'),
    path('honey-products/', views.honeyProduct, name='honey-products'),
    path('millets-products/', views.milletsProduct, name='millets-products'),
    path('natural-products/', views.naturalProduct, name='natural-products'),
    path('oil-products/', views.oilsProduct, name='oil-products'),
    path('tea-products/', views.organicProduct, name='tea-products'),
    path('cosmetic-products/', views.personalProduct, name='cosmetic-products'),
    path('poojan-products/', views.poojanProduct, name='poojan-products'),
    path('pulse-products/', views.pulsesProduct, name='pulses-products'),
    path('ready-products/', views.readyProduct, name='ready-products'),
    path('rice-products/', views.riceProduct, name='rice-products'),
    path('spices-products/', views.spicesProduct, name='spices-products'),
    path('sweets-products/', views.sweetsProduct, name='sweets-products'),
    path('vegtable-products/', views.vegetableProduct, name='vegetable-products'),
    path('basket-products/', views.basketsProduct, name='baskets-products'),
    path('breakfast-products/', views.breakfastProduct, name='breakfast-products'),
